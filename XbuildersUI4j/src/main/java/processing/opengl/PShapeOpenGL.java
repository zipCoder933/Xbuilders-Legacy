...
public class PShapeOpenGL extends PShape {
  ...
  static public final int TRANSLATE = 0;
  static public final int ROTATE    = 1;
  static public final int SCALE     = 2;
  static public final int MATRIX    = 3;

  public PGraphicsOpenGL pg;
  public PGL pgl;
  public int context;      // The context that created this shape.

  public PShapeOpenGL root;

  // ........................................................

  // Input, tessellated geometry

  public InGeometry inGeo;
  public TessGeometry tessGeo;
  public Tessellator tessellator;

  public AttributeMap polyAttribs;

  // ........................................................

  // Texturing

  public HashSet<PImage> textures;
  public boolean strokedTexture;
  public boolean untexChild;

  // ........................................................

  // OpenGL buffers

  public VertexBuffer bufPolyVertex;
  public VertexBuffer bufPolyColor;
  public VertexBuffer bufPolyNormal;
  public VertexBuffer bufPolyTexCoord;
  public VertexBuffer bufPolyAmbient;
  public VertexBuffer bufPolySpecular;
  public VertexBuffer bufPolyEmissive;
  public VertexBuffer bufPolyShininess;
  public VertexBuffer bufPolyIndex;

  public VertexBuffer bufLineVertex;
  public VertexBuffer bufLineColor;
  public VertexBuffer bufLineAttrib;
  public VertexBuffer bufLineIndex;

  public VertexBuffer bufPointVertex;
  public VertexBuffer bufPointColor;
  public VertexBuffer bufPointAttrib;
  public VertexBuffer bufPointIndex;

  // ........................................................

  // Offsets for geometry aggregation and update.

  public int polyVertCopyOffset;
  public int polyIndCopyOffset;
  public int lineVertCopyOffset;
  public int lineIndCopyOffset;
  public int pointVertCopyOffset;
  public int pointIndCopyOffset;

  public int polyIndexOffset;
  public int polyVertexOffset;
  public int polyVertexAbs;
  public int polyVertexRel;

  public int lineIndexOffset;
  public int lineVertexOffset;
  public int lineVertexAbs;
  public int lineVertexRel;

  public int pointIndexOffset;
  public int pointVertexOffset;
  public int pointVertexAbs;
  public int pointVertexRel;

  public int firstPolyIndexCache;
  public int lastPolyIndexCache;
  public int firstLineIndexCache;
  public int lastLineIndexCache;
  public int firstPointIndexCache;
  public int lastPointIndexCache;

  public int firstPolyVertex;
  public int lastPolyVertex;
  ...
  public PMatrix transformInv;
  public PMatrix matrixInv;
  ...
  public boolean needBufferInit = false;

  // Flag to indicate if the shape can have holes or not.
  public boolean solid = true;

  public boolean breakShape = false;
  public boolean shapeCreated = false;
  ...
  public int savedBezierDetail;
  public int savedCurveDetail;
  public float savedCurveTightness;
  ...
  static public final int NORMAL_MODE_AUTO = 0;
  // one normal manually specified per shape
  static public final int NORMAL_MODE_SHAPE = 1;
  // normals specified for each shape vertex
  static public final int NORMAL_MODE_VERTEX = 2;
  ...
  public boolean modifiedPolyVertices;
  public boolean modifiedPolyColors;
  public boolean modifiedPolyNormals;
  public boolean modifiedPolyTexCoords;
  public boolean modifiedPolyAmbient;
  public boolean modifiedPolySpecular;
  public boolean modifiedPolyEmissive;
  public boolean modifiedPolyShininess;

  public boolean modifiedLineVertices;
  public boolean modifiedLineColors;
  public boolean modifiedLineAttributes;

  public boolean modifiedPointVertices;
  public boolean modifiedPointColors;
  public boolean modifiedPointAttributes;

  public int firstModifiedPolyVertex;
  public int lastModifiedPolyVertex;
  public int firstModifiedPolyColor;
  public int lastModifiedPolyColor;
  public int firstModifiedPolyNormal;
  public int lastModifiedPolyNormal;
  public int firstModifiedPolyTexCoord;
  public int lastModifiedPolyTexCoord;
  public int firstModifiedPolyAmbient;
  public int lastModifiedPolyAmbient;
  public int firstModifiedPolySpecular;
  public int lastModifiedPolySpecular;
  public int firstModifiedPolyEmissive;
  public int lastModifiedPolyEmissive;
  public int firstModifiedPolyShininess;
  public int lastModifiedPolyShininess;

  public int firstModifiedLineVertex;
  public int lastModifiedLineVertex;
  public int firstModifiedLineColor;
  public int lastModifiedLineColor;
  public int firstModifiedLineAttribute;
  public int lastModifiedLineAttribute;

  public int firstModifiedPointVertex;
  public int lastModifiedPointVertex;
  public int firstModifiedPointColor;
  public int lastModifiedPointColor;
  public int firstModifiedPointAttribute;
  public int lastModifiedPointAttribute;
  ...
  public boolean savedStroke;
  public int savedStrokeColor;
  public float savedStrokeWeight;
  public int savedStrokeCap;
  public int savedStrokeJoin;

  public boolean savedFill;
  public int savedFillColor;

  public boolean savedTint;
  public int savedTintColor;

  public int savedAmbientColor;
  public int savedSpecularColor;
  public int savedEmissiveColor;
  public float savedShininess;

  public int savedTextureMode;
...
*/
  ...
  public void getVertexMin(PVector min) {
    updateTessellation();
  ...
  public void getVertexMax(PVector max) {
    updateTessellation();
  ...
  public int getVertexSum(PVector sum, int count) {
    updateTessellation();
  ...
  public void setTextureModeImpl(int mode) {
  ...
  public void setTextureImpl(PImage tex) {
    PImage image0 = image;
    image = tex;
  ...
  public void scaleTextureUV(float uFactor, float vFactor) {
    ...
    for (int i = 0; i < inGeo.vertexCount; i++) {
      ...
      inGeo.texcoords[2 * i + 0] = UIFrame.min(1, u * uFactor);
      inGeo.texcoords[2 * i + 1] = UIFrame.min(1, v * uFactor);
    }
    ...
    if (shapeCreated && tessellated && hasPolys) {
      ...
      for (int i = firstLineVertex; i < last1; i++) {
        ...
        tessGeo.polyTexCoords[2 * i + 0] = UIFrame.min(1, u * uFactor);
        tessGeo.polyTexCoords[2 * i + 1] = UIFrame.min(1, v * uFactor);
      }
  ...
  public void addTexture(PImage tex) {
    if (textures == null) {
  ...
  public void removeTexture(PImage tex, PShapeOpenGL caller) {
  ...
  public void strokedTexture(boolean newValue) {
    strokedTexture(newValue, null);
  }


  public void strokedTexture(boolean newValue, PShapeOpenGL caller) {
  ...
  public void untexChild(boolean newValue) {
    untexChild(newValue, null);
  }


  public void untexChild(boolean newValue, PShapeOpenGL caller) {
  ...
  public boolean hasTexture(PImage tex) {
    if (family == GROUP) {
  ...
  public void vertexImpl(float x, float y, float z, float u, float v) {
    if (!openShape) {
  ...
  public VertexAttribute attribImpl(String name, int kind, int type, int size) {
    if (4 < size) {
  ...
  public void transform(int type, float... args) {
  ...
  public void applyMatrixImpl(PMatrix matrix) {
    if (hasPolys) {
  ...
  @Override
  public void checkMatrix(int dimensions) {
    if (matrix == null) {
      if (dimensions == 2) {
  ...
  public void bezierVertexImpl(float x2, float y2, float z2,
                                  float x3, float y3, float z3,
                                  float x4, float y4, float z4) {
  ...
  public void quadraticVertexImpl(float cx, float cy, float cz,
                                     float x3, float y3, float z3) {
    inGeo.setMaterial(fillColor, strokeColor, strokeWeight,
                      ambientColor, specularColor, emissiveColor, shininess);
    inGeo.setNormal(normalX, normalY, normalZ);
...
//    pg.curveTightness(tightness);
  ...
  public void curveVertexImpl(float x, float y, float z) {
    inGeo.setMaterial(fillColor, strokeColor, strokeWeight,
                      ambientColor, specularColor, emissiveColor, shininess);
    inGeo.setNormal(normalX, normalY, normalZ);
  ...
  public void setFillImpl(int fill) {
  ...
  public void setTintImpl(int tint) {
  ...
  public void setStrokeImpl(boolean stroke) {
  ...
  public void setStrokeImpl(int stroke) {
  ...
  public void setStrokeWeightImpl(float weight) {
  ...
  public void setAmbientImpl(int ambient) {
  ...
  public void setSpecularImpl(int specular) {
  ...
  public void setEmissiveImpl(int emissive) {
  ...
  public void setShininessImpl(float shininess) {
  ...
  public float[] getAttrib(String name, int index, float[] values) {
    ...
    if (root.tessUpdate) {
      ...
      float[] tessAttrib = tessGeo.fpolyAttribs.get(name);
      int tessIdx = firstPolyVertex + index;
      UIFrame.arrayCopy(tessAttrib, attrib.tessSize * tessIdx, values, 0, attrib.tessSize);
    } else {
      if (values == null || values.length < attrib.size) values = new float[attrib.size];
      float[] array = inGeo.fattribs.get(name);
      UIFrame.arrayCopy(array, attrib.size * index, values, 0, attrib.size);
    }
  ...
  public void setAttrib(String name, int index, float... values) {
    ...
    if (root.tessUpdate) {
      ...
      float[] tessAttrib = tessGeo.fpolyAttribs.get(name);
      int tessIdx = firstPolyVertex + index;
      UIFrame.arrayCopy(values, 0, tessAttrib, attrib.tessSize * tessIdx, attrib.tessSize);
    } else {
      if (attrib.size != values.length)
        throw new RuntimeException("Length of values array is different from attribute size");
      float[] array = inGeo.fattribs.get(name);
      UIFrame.arrayCopy(values, 0, array, attrib.size * index, attrib.size);
      markForTessellation();
    }
  }
    ...
    if (0 < tessGeo.lineVertexCount) {
      ...
      for (int n = firstLineIndexCache; n <= lastLineIndexCache; n++) {
        ...
        for (int ln = ioffset / 6; ln < (ioffset + icount) / 6; ln++) {
          ...
          UIFrame.arrayCopy(vertices, 4 * i0, pt0, 0, 4);
          UIFrame.arrayCopy(vertices, 4 * i1, pt1, 0, 4);
      ...
      for (int n = 0; n < cache.size; n++) {
        ...
        while (pt < (ioffset + icount) / 3) {
          ...
          if (0 < size) { // round point
            weight = +size / 0.5f;
            perim = UIFrame.min(PGraphicsOpenGL.MAX_POINT_ACCURACY,
                    UIFrame.max(PGraphicsOpenGL.MIN_POINT_ACCURACY,
                            (int) (TWO_PI * weight /
  ...
  public void tessellateRect() {
    ...
    float maxRounding = UIFrame.min((c - a) / 2, (d - b) / 2);
    ...
    if (family == GROUP) {
      ...
      for (int i = 0; i < childCount; i++) {
        ...
        if (-1 < child.firstPolyVertex) {
          ...
          firstPolyVertex = UIFrame.min(firstPolyVertex, child.firstPolyVertex);
        }
        if (-1 < child.lastPolyVertex) {
          lastPolyVertex = UIFrame.max(lastPolyVertex, child.lastPolyVertex);
        }
      }
  ...
  public boolean startStrokedTex(int n) {
    return image != null && (n == firstLineIndexCache || n == firstPointIndexCache);
  }


  public void setFirstStrokeVertex(int n, int vert) {
  ...
  public void setLastStrokeVertex(int vert) {
    if (-1 < lastLineVertex) {
      lastLineVertex = vert;
    }
    ...
    if (family == GROUP) {
      ...
      for (int i = 0; i < childCount; i++) {
        ...
        if (-1 < child.firstLineVertex) {
          ...
          firstLineVertex = UIFrame.min(firstLineVertex, child.firstLineVertex);
        }
        if (-1 < child.lastLineVertex) {
          lastLineVertex = UIFrame.max(lastLineVertex, child.lastLineVertex);
        }
      }
    ...
    if (family == GROUP) {
      ...
      for (int i = 0; i < childCount; i++) {
        ...
        if (-1 < child.firstPointVertex) {
          ...
          firstPointVertex = UIFrame.min(firstPointVertex,
                                         child.firstPointVertex);
        }
        if (-1 < child.lastPointVertex) {
          lastPointVertex = UIFrame.max(lastPointVertex, child.lastPointVertex);
        }
      }
  ...
  public void copyPolyVertices(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyVertex.glId);
  ...
  public void copyPolyColors(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyColor.glId);
  ...
  public void copyPolyNormals(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyNormal.glId);
  ...
  public void copyPolyTexCoords(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyTexCoord.glId);
  ...
  public void copyPolyAmbient(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyAmbient.glId);
  ...
  public void copyPolySpecular(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolySpecular.glId);
  ...
  public void copyPolyEmissive(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyEmissive.glId);
  ...
  public void copyPolyShininess(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPolyShininess.glId);
  ...
  public void copyPolyAttrib(VertexAttribute attrib, int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, attrib.buf.glId);
  ...
  public void copyLineVertices(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufLineVertex.glId);
  ...
  public void copyLineColors(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufLineColor.glId);
  ...
  public void copyLineAttributes(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufLineAttrib.glId);
  ...
  public void copyPointVertices(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPointVertex.glId);
  ...
  public void copyPointColors(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPointColor.glId);
  ...
  public void copyPointAttributes(int offset, int size) {
    pgl.bindBuffer(PGL.ARRAY_BUFFER, bufPointAttrib.glId);
  ...
  public void setModifiedPolyVertices(int first, int last) {
  ...
  public void setModifiedPolyColors(int first, int last) {
  ...
  public void setModifiedPolyNormals(int first, int last) {
  ...
  public void setModifiedPolyTexCoords(int first, int last) {
  ...
  public void setModifiedPolyAmbient(int first, int last) {
  ...
  public void setModifiedPolySpecular(int first, int last) {
  ...
  public void setModifiedPolyEmissive(int first, int last) {
  ...
  public void setModifiedPolyShininess(int first, int last) {
  ...
  public void setModifiedPolyAttrib(VertexAttribute attrib, int first, int last) {
  ...
  public void setModifiedLineVertices(int first, int last) {
  ...
  public void setModifiedLineColors(int first, int last) {
  ...
  public void setModifiedLineAttributes(int first, int last) {
  ...
  public void setModifiedPointVertices(int first, int last) {
  ...
  public void setModifiedPointColors(int first, int last) {
  ...
  public void setModifiedPointAttributes(int first, int last) {
  ...
  @Override
  public void styles(PGraphics g) {
  ...
  public boolean fragmentedGroup(PGraphicsOpenGL g) {
  ...
  @Override
  public void drawGeometry(PGraphics g) {
  ...
  public void render(PGraphicsOpenGL g, PImage texture) {
    if (root == null) {
  ...
  public void renderPolys(PGraphicsOpenGL g, PImage textureImage) {
  ...
  public void rawPolys(PGraphicsOpenGL g, PImage textureImage) {
    ...
    for (int n = firstPolyIndexCache; n <= lastPolyIndexCache; n++) {
      ...
      for (int tr = ioffset / 3; tr < (ioffset + icount) / 3; tr++) {
        ...
        UIFrame.arrayCopy(vertices, 4 * i0, src0, 0, 4);
        UIFrame.arrayCopy(vertices, 4 * i1, src1, 0, 4);
        UIFrame.arrayCopy(vertices, 4 * i2, src2, 0, 4);
  ...
  public void renderLines(PGraphicsOpenGL g) {
  ...
  public void rawLines(PGraphicsOpenGL g) {
    PGraphics raw = g.getRaw();
  ...
  public void renderPoints(PGraphicsOpenGL g) {
  ...
  public void rawPoints(PGraphicsOpenGL g) {
    PGraphics raw = g.getRaw();
