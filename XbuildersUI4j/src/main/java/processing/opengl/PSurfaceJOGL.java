...
public class PSurfaceJOGL implements PSurface {
    ...
    public void initFrame(UIFrame sketch) {
        this.sketch = sketch;
...
//    pgl.reqNumSamples = PGL.smoothToSamples(graphics.smooth);
    ...
    protected void initWindow() {
        ...
        windowScaleFactor
                = (UIFrame.platform == PConstants.MACOS) ? 1 : sketch.pixelDensity;
...
//      sketchHeight = (int) (uiScale * screenRect.height / windowScaleFactor);
        ...
        float surfaceScale
                = (graphics.is2X() && UIFrame.platform == PConstants.MACOS)
...
//                        throw new RuntimeException(cause);
    ...
    private String resourceFilename(String filename) {
        // The code below comes from UIFrame.createInputRaw() with a few adaptations
        InputStream stream;
        try {
    ...
    public class DrawListener implements GLEventListener {
        ...
        public void display(GLAutoDrawable drawable) {
            ...
            if (sketch.exitCalled()) {
                ...
                sketch.windowCloseEvent(); // calls stopThread(), which stops the animator.
        ...
        public void reshape(GLAutoDrawable drawable, int x, int y, int w, int h) {
            ...
            synchronized (getSyncMutex(drawable)) {
                pgl.resetFBOLayer();
                float scale = UIFrame.platform == PConstants.MACOS
