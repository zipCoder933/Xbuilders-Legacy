 ...
 * fragment shader. It is compatible with P2D and P3D, but not with the default
 * renderer.
 *
 * Use the <b>loadShader()</b> function to load your shader code. Note: It's
 * strongly encouraged to use <b>loadShader()</b> to create a <b>PShader</b>
 * object, rather than calling the <b>PShader</b>
...
public class PShader implements PConstants {
     ...
     */
    public PShader(UIFrame parent, String vertFilename, String fragFilename) {
        this.parent = parent;
        primaryPG = (PGraphicsOpenGL) parent.g;
        pgl = primaryPG.pgl;
     ...
     */
    public PShader(UIFrame parent, URL vertURL, URL fragURL) {
        this.parent = parent;
        primaryPG = (PGraphicsOpenGL) parent.g;
        pgl = primaryPG.pgl;
    ...
    public PShader(UIFrame parent, String[] vertSource, String[] fragSource) {
        this.parent = parent;
        primaryPG = (PGraphicsOpenGL) parent.g;
        pgl = primaryPG.pgl;
...
//    }
    ...
    public void set(String name, Matrix4f mat) {
        ...
        matvJOML[14] = mat.m32();
        matvJOML[15] = mat.m33();
        this.setUniformImpl(name, 18, matvJOML);
    }

    public void setUniformImpl(String name, int type, Object value) {
    ...
    protected boolean compileVertexShader() {
        pgl.shaderSource(glVertex, UIFrame.join(vertexShaderSource, "\n"));
    ...
    protected boolean compileFragmentShader() {
        pgl.shaderSource(glFragment, UIFrame.join(fragmentShaderSource, "\n"));
    ...
    static protected int getShaderType(String[] source, int defaultType) {
        for (String s : source) {
            ...
            if (UIFrame.match(line, colorShaderDefRegexp) != null) {
                return PShader.COLOR;
            } else if (UIFrame.match(line, lightShaderDefRegexp) != null) {
                return PShader.LIGHT;
            } else if (UIFrame.match(line, texShaderDefRegexp) != null) {
                return PShader.TEXTURE;
            } else if (UIFrame.match(line, texlightShaderDefRegexp) != null) {
                return PShader.TEXLIGHT;
            } else if (UIFrame.match(line, polyShaderDefRegexp) != null) {
                return PShader.POLY;
            } else if (UIFrame.match(line, triShaderAttrRegexp) != null) {
                return PShader.POLY;
            } else if (UIFrame.match(line, quadShaderAttrRegexp) != null) {
                return PShader.POLY;
            } else if (UIFrame.match(line, pointShaderDefRegexp) != null) {
                return PShader.POINT;
            } else if (UIFrame.match(line, lineShaderDefRegexp) != null) {
                return PShader.LINE;
            } else if (UIFrame.match(line, pointShaderAttrRegexp) != null) {
                return PShader.POINT;
            } else if (UIFrame.match(line, pointShaderInRegexp) != null) {
                return PShader.POINT;
            } else if (UIFrame.match(line, lineShaderAttrRegexp) != null) {
                return PShader.LINE;
            } else if (UIFrame.match(line, lineShaderInRegexp) != null) {
                return PShader.LINE;
            }
        }
        return defaultType;
