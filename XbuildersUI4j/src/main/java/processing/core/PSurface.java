...
public interface PSurface {
  ...
  //public Component initComponent(UIFrame sketch);

  //public Frame initFrame(UIFrame sketch, Color backgroundColor,
//  public void initFrame(UIFrame sketch, int backgroundColor,
//                        int deviceIndex, boolean fullScreen, boolean spanDisplays);
  ...
  // Just call these on an AWT Frame object stored in UIFrame.
...
//  public void placeWindow(int[] location);
  ...
  // sets displayWidth/Height inside UIFrame
...
//  /**
//   * Called by {@link UIFrame#createGraphics} to initialize the
...
//  // finish rendering to the screen (called by UIFrame)
//  public void blit();
