...
public class PShapeOBJ extends PShape {
   ...
   */
  public PShapeOBJ(UIFrame parent, String filename) {
    this(parent, parent.createReader(filename), getBasePath(parent, filename));
  }

  public PShapeOBJ(UIFrame parent, BufferedReader reader) {
    this(parent, reader, "");
  }

  public PShapeOBJ(UIFrame parent, BufferedReader reader, String basePath) {
  ...
  protected void addChildren(ArrayList<OBJFace> faces,
    ...
    for (int i = 0; i < faces.size(); i++) {
      ...
      if (mtlIdxCur != face.matIdx || face.matIdx == -1) {
        ...
        mtlIdxCur = UIFrame.max(0, face.matIdx);
  ...
  static protected void parseOBJ(UIFrame parent, String path,
  ...
  static protected void parseMTL(UIFrame parent, String mtlfn, String path,
                                 BufferedReader reader,
                                 ArrayList<OBJMaterial> materials,
  ...
  static protected String getBasePath(UIFrame parent, String filename) {
    // Obtaining the path
