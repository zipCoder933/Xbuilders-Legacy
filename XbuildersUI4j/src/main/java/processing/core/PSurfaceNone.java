...
//  }
    ...
    public void pauseThread() {
        System.out.println("PApplet.run() paused, calling object wait...");
        paused = true;
    }
    ...
    protected void checkPause() {
        if (paused) {
            synchronized (pauseObject) {
                try {
                    pauseObject.wait();
//          UIFrame.debug("out of wait");
                } catch (InterruptedException e) {
                    // waiting for this interrupt on a start() (resume) call
                }
            }
        }
//    UIFrame.debug("done with pause");
    }
...
//        }
            ...
            sketch.windowCloseEvent();// call to shutdown libs?
