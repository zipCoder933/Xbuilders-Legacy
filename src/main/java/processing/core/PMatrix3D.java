  ...
  */
  ...
  public void print() {
    ...
    */
    ...
    System.out.println(UIFrame.nfs(m00, digits, 4) + " " +
                       UIFrame.nfs(m01, digits, 4) + " " +
                       UIFrame.nfs(m02, digits, 4) + " " +
                       UIFrame.nfs(m03, digits, 4));

    System.out.println(UIFrame.nfs(m10, digits, 4) + " " +
                       UIFrame.nfs(m11, digits, 4) + " " +
                       UIFrame.nfs(m12, digits, 4) + " " +
                       UIFrame.nfs(m13, digits, 4));

    System.out.println(UIFrame.nfs(m20, digits, 4) + " " +
                       UIFrame.nfs(m21, digits, 4) + " " +
                       UIFrame.nfs(m22, digits, 4) + " " +
                       UIFrame.nfs(m23, digits, 4));

    System.out.println(UIFrame.nfs(m30, digits, 4) + " " +
                       UIFrame.nfs(m31, digits, 4) + " " +
                       UIFrame.nfs(m32, digits, 4) + " " +
                       UIFrame.nfs(m33, digits, 4));
