...
public class PVector implements Serializable {
   ...
   * <b>this</b> as an argument, it will use the UIFrame's random number
 generator.
   *
   * @webref pvector:method
   * @usage web_application
   ...
   * @param parent current UIFrame instance
   * @return the random PVector
   */
  static public PVector random2D(UIFrame parent) {
   ...
   * @return the random PVector
   */
  static public PVector random2D(PVector target, UIFrame parent) {
    return (parent == null) ?
 ...
 generator.
   ...
   * @return the random PVector
   */
  static public PVector random3D(UIFrame parent) {
   ...
   * @return the random PVector
   */
  static public PVector random3D(PVector target, UIFrame parent) {
    float angle;
    float vz;
    if (parent == null) {
  ...
  public PVector rotate(float theta) {
    ...
    x = x*UIFrame.cos(theta) - y*UIFrame.sin(theta);
    y = temp*UIFrame.sin(theta) + y*UIFrame.cos(theta);
    return this;
  }
  ...
  public PVector lerp(PVector v, float amt) {
    x = UIFrame.lerp(x, v.x, amt);
    y = UIFrame.lerp(y, v.y, amt);
    z = UIFrame.lerp(z, v.z, amt);
    return this;
  }
  ...
  public PVector lerp(float x, float y, float z, float amt) {
    this.x = UIFrame.lerp(this.x, x, amt);
    this.y = UIFrame.lerp(this.y, y, amt);
    this.z = UIFrame.lerp(this.z, z, amt);
    return this;
  }
