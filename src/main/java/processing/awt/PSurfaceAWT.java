...
//  }
  ...
  @Override
  public void initOffscreen(UIFrame sketch) {
    this.sketch = sketch;
  }


  @Override
  public void initFrame(final UIFrame sketch) {/*, int backgroundColor,
...
//    System.out.println("display from sketch is " + displayNum);
    ...
    // Set the displayWidth/Height variables inside UIFrame, so that they're
    // usable and can even be returned by the sketchWidth()/Height() methods.
    sketch.displayWidth = screenRect.width;
    sketch.displayHeight = screenRect.height;

    // windowScaleFactor = UIFrame.platform == PConstants.MACOS ?
...
//      frame.pack();
    ...
    frame.addWindowListener(new WindowAdapter() {
      ...
      public void windowClosing(WindowEvent e) {
        sketch.windowCloseEvent();  // don't quit, need to just shut everything down (0133)
      }
    });
...
//  }
  ...
  public void setTitle(String title) {
    ...
    if (cursorVisible &&
        (UIFrame.platform == PConstants.MACOS) &&
  ...
  protected void setProcessingIcon(Frame frame) {
    ...
    if (UIFrame.platform != PConstants.MACOS) {
      ...
      try {
        if (iconImages == null) {
          ...
          for (int sz : sizes) {
            ...
            URL url = UIFrame.class.getResource("/icon/icon-" + sz + ".png");
      ...
      if (!dockIconSpecified()) {  // don't override existing -Xdock param
        ...
        URL url = UIFrame.class.getResource("/icon/icon-512.png");
...
/*
    if (visible && UIFrame.platform == PConstants.LINUX) {
      ...
      if (UIFrame.platform == PConstants.LINUX) {
...
//    if (UIFrame.platform == PConstants.MACOSX) {
...
//  }
  ...
  */
  ...
  public void setCursor(int kind) {
    ...
    if (UIFrame.platform == PConstants.MACOS && kind == PConstants.MOVE) {
