...
//<editor-fold defaultstate="collapsed" desc="Draw wheel">
//NOTES:
//The UV map for this block only exists on the top face.


    //<editor-fold defaultstate="collapsed" desc="Verticies">
    static Vector3f[] verts_wheel = {new Vector3f(1.02f, 0.7f, 0.0f), //VERT 0
            new Vector3f(1.02f, 0.7f, 0.96f), //VERT 1
            new Vector3f(1.02f, 0.26f, 0.0f), //VERT 2
            new Vector3f(1.02f, 0.26f, 0.96f), //VERT 3
            new Vector3f(0.7f, -0.06f, 0.0f), //VERT 4
            new Vector3f(0.7f, -0.06f, 0.96f), //VERT 5
            new Vector3f(0.26f, -0.06f, 0.0f), //VERT 6
            new Vector3f(0.26f, -0.06f, 0.96f), //VERT 7
            new Vector3f(-0.06f, 0.26f, 0.0f), //VERT 8
            new Vector3f(-0.06f, 0.26f, 0.96f), //VERT 9
            new Vector3f(-0.06f, 0.7f, 0.0f), //VERT 10
            new Vector3f(-0.06f, 0.7f, 0.96f), //VERT 11
            new Vector3f(0.26f, 1.02f, 0.0f), //VERT 12
            new Vector3f(0.26f, 1.02f, 0.96f), //VERT 13
            new Vector3f(0.7f, 1.02f, 0.0f), //VERT 14
            new Vector3f(0.7f, 1.02f, 0.96f), //VERT 15
    };
    static Vector2f[] uv_wheel = {new Vector2f(1.0f, 0.0f), //UV 0
            new Vector2f(0.0f, 0.12f), //UV 1
            new Vector2f(0.0f, 0.0f), //UV 2
            new Vector2f(1.0f, 0.12f), //UV 3
            new Vector2f(0.0f, 0.26f), //UV 4
            new Vector2f(1.0f, 0.26f), //UV 5
            new Vector2f(0.0f, 0.38f), //UV 6
            new Vector2f(1.0f, 0.38f), //UV 7
            new Vector2f(0.0f, 0.5f), //UV 8
            new Vector2f(1.0f, 0.5f), //UV 9
            new Vector2f(0.0f, 0.62f), //UV 10
            new Vector2f(1.0f, 0.62f), //UV 11
            new Vector2f(0.0f, 0.76f), //UV 12
            new Vector2f(0.3f, 1.0f), //UV 13
            new Vector2f(0.0f, 0.3f), //UV 14
            new Vector2f(0.7f, 0.0f), //UV 15
            new Vector2f(1.0f, 0.76f), //UV 16
            new Vector2f(0.0f, 0.88f), //UV 17
            new Vector2f(1.0f, 0.88f), //UV 18
...
//</editor-fold>
    ...
    public void constructBlock(PShape buffers, Block block, BlockData data, Block negativeX, Block positiveX, Block negativeY, Block positiveY, Block negativeZ, Block positiveZ, int x, int y, int z) {
        ...
        make_wheel_positiveY_faces(verts2, uv_wheel, block, buffers, x, y, z);
        make_wheel_negativeX_faces(verts2, uv_wheel, block, buffers, x, y, z);
        make_wheel_positiveX_faces(verts2, uv_wheel, block, buffers, x, y, z);
        make_wheel_negativeZ_faces(verts2, uv_wheel, block, buffers, x, y, z);
        make_wheel_positiveZ_faces(verts2, uv_wheel, block, buffers, x, y, z);
        make_wheel_center_faces(verts2, uv_wheel, block, buffers, x, y, z);
    }
}
