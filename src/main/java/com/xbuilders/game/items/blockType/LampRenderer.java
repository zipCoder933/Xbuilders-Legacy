...
//</editor-fold>
    public boolean constructBlock_lamp(Block block, BlockMesh_Base shape, Block negativeX, Block positiveX, Block negativeY, Block positiveY, Block negativeZ, Block positiveZ, int x, int y, int z) {
...
//<editor-fold defaultstate="collapsed" desc="Face methods">
    private static void make_lamp_center_faces(Vector3f[] verts2, Vector2f[] uv2, Block block, BlockMesh_Base shape, int x, int y, int z) {
...
//</editor-fold>
    public boolean constructBlock_lamp_side(Block block, BlockMesh_Base shape, Block negativeX, Block positiveX, Block negativeY, Block positiveY, Block negativeZ, Block positiveZ, int x, int y, int z) {
...
//<editor-fold defaultstate="collapsed" desc="Face methods">
    private static void make_lamp_side_center_faces(Vector3f[] verts2, Vector2f[] uv2, Block block, BlockMesh_Base shape, int x, int y, int z) {
        int[] pos = block.texture.TOP;
...
//</editor-fold>
    public boolean constructBlock_lamp_side_fence(Block block, BlockMesh_Base shape, Block negativeX, Block positiveX, Block negativeY, Block positiveY, Block negativeZ, Block positiveZ, int x, int y, int z) {
...
//<editor-fold defaultstate="collapsed" desc="Face methods">
    private static void make_lamp_side_fence_center_faces(Vector3f[] verts2, Vector2f[] uv2, Block block, BlockMesh_Base shape, int x, int y, int z) {
        int[] pos = block.texture.TOP;
