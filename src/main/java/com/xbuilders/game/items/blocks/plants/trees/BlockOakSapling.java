...
public class BlockOakSapling extends Block {
    ...
    public BlockOakSapling() {
        super(160, "Oak Sapling");
        this.type = BlockRenderType.SPRITE;
        this.texture = new BlockTexture(15, 3);
    ...
    public boolean setBlock(final int x, final int y, final int z, BlockData orientation) {
        ...
        (new BlockAction(getPointerHandler(), x, y, z) {
            ...
            public void onInterrupt() {
                OakTreeUtils.plantTree(getPointerHandler(), MiscUtils.getRandom(), x, y, z);
            }
            ...
            public void preformAction() throws InterruptedException {
                ...
                if (VoxelGame.getWorld().getBlock(x, y, z) == GameItems.BlockOakSapling
